...
- <strong>You are not allowed to use any kind of loops</strong>
...
- [`0-puts_recursion.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/0-puts_recursion.c)
...
- [`1-print_rev_recursion.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/1-print_rev_recursion.c)
...
- [`2-strlen_recursion.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/2-strlen_recursion.c)
...
julien@ubuntu:~/Recursion$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89
2
-main.c
2
-strlen_recursion.c -o
2
-strlen_recursion
julien@ubuntu:~/Recursion$ ./
2
...
- [`3-factorial.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/3-factorial.c)
...
- [`4-pow_recursion.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/4-pow_recursion.c)
...
- [`5-sqrt_recursion.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/5-sqrt_recursion.c)
...
If
n
does not have a natural square root, the function should return
-1
FYI: The standard library provides a different function:
sqrt
. Run
...
- [`6-is_prime_number.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/recursion/6-is_prime_number.c)
