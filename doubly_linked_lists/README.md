...
- [`0-print_dlistint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/0-print_dlistint.c)
...
Format: see example
julien@ubuntu:~/Doubly linked lists$ cat
0
-main.c
#
include
...
julien@ubuntu:~/Doubly linked lists$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89
0
-main.c
0
-print_dlistint.c -o a
...
- [`1-dlistint_len.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/1-dlistint_len.c)
...
- [`2-add_dnodeint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/2-add_dnodeint.c)
...
- [`3-add_dnodeint_end.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/3-add_dnodeint_end.c)
...
- [`4-free_dlistint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/4-free_dlistint.c)
...
- [`5-get_dnodeint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/5-get_dnodeint.c)
...
where
index
is the index of the node, starting from
0
...
- [`6-sum_dlistint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/6-sum_dlistint.c)
...
julien@ubuntu:~/Doubly linked lists$ gcc -Wall -pedantic -Werror -Wextra
6
-main.c -std=gnu89
3
-add_dnodeint_end.c
...
- [`7-insert_dnodeint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/7-insert_dnodeint.c)
- [`2-add_dnodeint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/2-add_dnodeint.c)
- [`3-add_dnodeint_end.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/3-add_dnodeint_end.c)
...
where
idx
is the index of the list where the new node should be added. Index starts at
0
...
idx
, do not add the new node and return
NULL
Your files
2-add_dnodeint.c
and
...
- [`8-delete_dnodeint.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/doubly_linked_lists/8-delete_dnodeint.c)
...
where
index
is the index of the node that should be deleted. Index starts at
0
Returns:
1
if it succeeded,
