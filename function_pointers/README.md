...
**Answer:** `An array of pointers to functions that take an int and a float as parameters and returns nothing`
...
**Answer:** `The first byte of code of the function`
...
- [`0-print_name.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/0-print_name.c)
...
julien@ubuntu:~/
0x0e
. Function pointers$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89
0
-main.c
0
-print_name.c -o a
...
- [`1-array_iterator.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/1-array_iterator.c)
...
- [`2-int_index.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/2-int_index.c)
...
- [`3-main.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/3-main.c)
- [`3-op_functions.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/3-op_functions.c)
- [`3-get_op_func.c`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/3-get_op_func.c)
- [`3-calc.h`](https://github.com/Antgst/holbertonschool-low_level_programming/blob/main/function_pointers/3-calc.h)
...
and
num2
are integers, so use the
atoi
function to convert them from the string input to
int
operator
